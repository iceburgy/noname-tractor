...
var MainForm = /** @class */ (function () {
    ...
    MainForm.prototype.drawFrameMain = function () {
        var frmMain = this.gameScene.ui.create.div('.framemain', this.gameScene.ui.window);
    ...
    MainForm.prototype.drawFrameChat = function () {
        var frmChat = this.gameScene.ui.create.div('.framechat', this.gameScene.ui.window);
    ...
    MainForm.prototype.drawGameHall = function (roomStateList, playerList) {
        var textHall = this.gameScene.ui.create.div('', '大厅', this.gameScene.ui.frmMain);
        ...
        for (var i = 0; i < playerList.length; i++) {
            var textHallPlayer = this.gameScene.ui.create.div('', playerList[i], this.gameScene.ui.frmMain);
