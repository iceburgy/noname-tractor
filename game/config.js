window.config={
	...
	all:{
		sgscharacters:['cunguiyuanchuang','standard','shenhua','xinghuoliaoyuan','refresh','yijiang','sp','sp2','extra','old','mobile','tw'],
	...
	characters:['cunguiyuanchuang','standard','shenhua','sp','sp2','yijiang','refresh','xinghuoliaoyuan','mobile','extra'],
